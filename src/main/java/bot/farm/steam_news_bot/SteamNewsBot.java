...
import static bot.farm.steam_news_bot.localization.message.MessageEnum.ALREADY_SUBSCRIBED;
...
import static bot.farm.steam_news_bot.localization.message.MessageEnum.PROBLEM_WITH_NETWORK_OR_STEAM_SERVICE;
...
import static bot.farm.steam_news_bot.localization.message.MessageEnum.SUBSCRIBE;
...
import static bot.farm.steam_news_bot.localization.message.MessageEnum.WISHLIST_AVAILABLE;
import static bot.farm.steam_news_bot.localization.message.MessageEnum.WISHLIST_NOT_AVAILABLE;
